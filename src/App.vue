  ...
  <div id="app" class="min-h-screen bg-gray-200 antialiased">
    ...
    <section class="flex justify-between bg-gray-800 px-4 py-3">
      <div class="relative">
        ...
        <input
          class="bg-gray-900 focus:outline-none focus:bg-white focus:text-gray-900 text-white rounded-lg pl-10 pr-3 py-2 "
          placeholder="Search by keywords">

      </div>
      <button
        class="inline-flex items-center bg-gray-700 hover:bg-gray-600 focus:outline-none focus:shadow-outline rounded-lg shadow px-4">
    ...
    <main class="px-4 py-6">
      ...
      <p class="text-gray-600">Like like the starts in these luxirious Sothern California estates.</p>
      <div class="mt-4">
        <div>
          <img class="rounded-lg shadonw-md h-64"
        ...
        <div class="relative px-4 -mt-16">
          <div class="bg-white rounded-lg px-4 py-3 shadow-lg">
            <div class="flex">
              <span
                class="px-2 py-1 leading-none bg-teal-200 text-teal-800 rounded-full font-semibold font-medium uppercase tracking-wide text-xs">Plus</span>
              <div class="ml-2 text-xs text-gray-600 font-semibold uppercase tracking-wide">
                3 beds &bull; 2 baths
              </div>
            </div>
            <h4 class="mt-1 text-gray-900 font-semibold">Modern home in city center</h4>
            <div class="mt-1">
              <span class="text-gray-900">$1,400</span><span class="ml-1 text-sm text-gray-600">/wk</span>
            </div>
            <div class="mt-1 flex items-center text-sm text-gray-600">
              ...
              <span class="ml-1">34 reviews</span>
            </div>
          </div>
        </div>
      </div>
